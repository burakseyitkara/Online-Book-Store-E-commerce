...
<main id="books" style="height: auto; ">
  <div class="container">
    ...
    <h2 class="pt-4 pb-3" style="font-family: 'Special Elite', cursive;
                        ...
                        letter-spacing: 7px;"> YENİ ÇIKAN KİTAPLAR </h2>

    <div style="float: left; margin-left:18px;">
      <button disabled style="background:#efefef;color:#000000;">Fiyata Göre Sırala</button>
      <a href="siralama.php?sort=azalan-yc"><button> <i class="fas fa-sort-amount-down-alt"></i></button> </a>
      <a href="siralama.php?sort=artan-yc"><button> <i class="fas fa-sort-amount-up-alt"></i></button> </a>
    </div>

    <div style="float: right; margin-right:63px;">
      <button disabled style="background:#efefef;color:#000000;">Alfabetik Sırala</button>
      <a href="siralama.php?sort=az-yc"><button><i class="fas fa-sort-alpha-down"></i></button> </a>
      <a href="siralama.php?sort=za-yc"><button><i class="fas fa-sort-alpha-up"></i></button> </a>
    </div>
    ...
    <div class="container ">
      <div class="row ">
        ...
        $query = $db->query("SELECT * FROM `books` WHERE bookId BETWEEN 21 AND 30");
